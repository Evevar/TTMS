...
import { $schedule, $delschedule } from '../../api/scheduleapi';
...
export default function Schedule() {
    ...
    const loadList = () => {
        $schedule(Current).then((data, count) => {
            count = data.length
    ...
    return (
        <> {contextHolder}
            ...
            />
            <AddSchedule open={open} setOpen={setOpen} loadList={loadList} Id={Id} setId={setId} />
        </>
    )
}