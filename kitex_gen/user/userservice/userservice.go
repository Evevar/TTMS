...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"GetAllUser":         kitex.NewMethodInfo(getAllUserHandler, newGetAllUserArgs, newGetAllUserResult, false),
...
func (p *GetAllUserArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetAllUserArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetAllUserResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetAllUserResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *ChangeUserPasswordArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in ChangeUserPasswordArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *ChangeUserPasswordResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in ChangeUserPasswordResult")
	}
	return proto.Marshal(p.Success)
}
