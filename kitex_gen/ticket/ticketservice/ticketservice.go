...
var ticketServiceServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "TicketService"
	handlerType := (*ticket.TicketService)(nil)
	methods := map[string]kitex.MethodInfo{
		"BatchAddTicket": kitex.NewMethodInfo(batchAddTicketHandler, newBatchAddTicketArgs, newBatchAddTicketResult, false),
		"UpdateTicket":   kitex.NewMethodInfo(updateTicketHandler, newUpdateTicketArgs, newUpdateTicketResult, false),
		"GetAllTicket":   kitex.NewMethodInfo(getAllTicketHandler, newGetAllTicketArgs, newGetAllTicketResult, false),
		"BuyTicket":      kitex.NewMethodInfo(buyTicketHandler, newBuyTicketArgs, newBuyTicketResult, false),
		"ReturnTicket":   kitex.NewMethodInfo(returnTicketHandler, newReturnTicketArgs, newReturnTicketResult, false),
	}
...
func (p *BatchAddTicketArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in BatchAddTicketArgs")
	}
...
func (p *BatchAddTicketResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in BatchAddTicketResult")
	}
...
func (p *UpdateTicketArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in UpdateTicketArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *UpdateTicketResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in UpdateTicketResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *GetAllTicketArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetAllTicketArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetAllTicketResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetAllTicketResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *BuyTicketArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in BuyTicketArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *BuyTicketResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in BuyTicketResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *ReturnTicketArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in ReturnTicketArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *ReturnTicketResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in ReturnTicketResult")
	}
	return proto.Marshal(p.Success)
}
